...
namespace App\Loyalty\Infrastructure\Projection;
 ...
 * this projection just wrote, and Messenger gives no ordering guarantee between
 * independent handlers of one message.
 */
final readonly class WalletProjection
{
